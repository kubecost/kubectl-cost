...
Once the release completes, the [Krew manifest](https://github.com/kubernetes-sigs/krew-index/pull/1158) should be automatically updated in the same workflow using [krew-release-bot](https://github.com/kubecost/krew-release-bot). Make sure this succeeds - the PR to krew-index should be merged automatically.
